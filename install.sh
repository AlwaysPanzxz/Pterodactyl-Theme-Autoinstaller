...
check_token() {
  ...
  if [ "$USER_TOKEN" = "coza" ]; then
    echo -e "${GREEN}AKSES BERHASIL${NC}}"
  else
    echo -e "${GREEN}Token Salah! Beli Kode Token Di PanzxzModss${NC}"
    echo -e "${YELLOW}TELEGRAM : @PanzxzModss${NC}"
    echo -e "${YELLOW}WHATSAPP : +6282338070044${NC}"
    echo -e "${YELLOW}HARGA TOKEN : 10K FREE UPDATE JIKA ADA TOKEN BARU${NC}"
    echo -e "${YELLOW}© PanzxzModss${NC}"
    exit 1
  fi
  clear
}
...
install_theme() {
  while true; do
    ...
    case "$SELECT_THEME" in
      1)
        THEME_URL=$(echo -e "https://github.com/AlwaysPanzxz/Pterodactyl-Theme-Autoinstaller/raw/main/stellar.zip")        
        break
        ;;
      2)
        THEME_URL=$(echo -e "https://github.com/AlwaysPanzxz/Pterodactyl-Theme-Autoinstaller/raw/main/billing.zip")
        break
        ;;
      3)
        THEME_URL=$(echo -e "https://github.com/AlwaysPanzxz/Pterodactyl-Theme-Autoinstaller/raw/main/enigma.zip")
        break
        ;; 
      x)
        return
...
while true; do
  ...
  echo -e "${RED}'ggg      ,gg'''  .    ggg       Auto Installer PanzxzModss  ${NC}"
  echo -e "${RED}gggg      gg     ,     ggg      ------------------------  ${NC}"
  echo -e "${RED}ggg:     gg.     -   ,ggg       • Telegram : @PanzxzModss      ${NC}"
  echo -e "${RED} ggg:     ggg._    _,ggg        • Creadit  : ©PanzxzModss  ${NC}"
  echo -e "${RED} ggg.    '.'''ggggggp           • Support by PanzxzModss  ${NC}"
